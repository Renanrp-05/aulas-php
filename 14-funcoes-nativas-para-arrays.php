...
<body>
    ...
    <div class="container">
        ...
        <?php
            $arrayBandas = ["Pink Floyd", "Genensis", "Yes"];
        ...
        <?php
            $categorias = [
                "Eletrônicos", "Livros", "Roupas", "Livros", "Games",
                "Eletrônicos",
            ];
        ...
        <h2>array_merge()</h2>
        <p>Junto dados de arrays diferentes.</p>
        <?php
        ...
        <?php
            $servicosConcluidos = array_filter(
                $servicos, fn(array $servico):bool => $servico["status"] === "Pendente"
            );
        ?>
